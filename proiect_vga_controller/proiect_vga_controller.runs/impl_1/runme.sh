...
HD_PWD='C:/Facultate/An1sem2/PSN/proiect_vga_controller/proiect_vga_controller/proiect_vga_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Shapes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_Shapes.tcl -notrace
