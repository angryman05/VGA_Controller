...
HD_PWD='C:/Facultate/An1sem2/PSN/proiect_vga_controller/proiect_vga_controller/proiect_vga_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Shapes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_Shapes.tcl
